...
A Tabela \ref{tab:protocolo-validacao} sintetiza o protocolo utilizado para orientar a etapa final de validação funcional do protótipo, relacionando os cenários avaliados, as entradas utilizadas e os critérios de sucesso observados.
...
\begin{tabularx}{\textwidth}{>{\raggedright\arraybackslash}p{2.8cm}>{\raggedright\arraybackslash}p{3.2cm}>{\raggedright\arraybackslash}p{3.1cm}>{\raggedright\arraybackslash}X}
\toprule
\textbf{Cenário} & \textbf{Entrada controlada} & \textbf{Relação com o inventário} & \textbf{Critério de sucesso} \\
\midrule
