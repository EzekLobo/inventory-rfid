...
A Figura \ref{fig:casos-uso-rfid} apresenta os principais casos de uso funcionais do protótipo. Os requisitos não funcionais não são representados como casos de uso, pois descrevem atributos de qualidade e restrições da solução, sendo por isso apresentados junto ao levantamento de requisitos.
