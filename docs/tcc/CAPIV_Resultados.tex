...
A quantidade de execuções não foi utilizada como amostragem estatística, mas como mecanismo de confirmação funcional. A repetição dos cenários permitiu observar se o sistema mantinha comportamento consistente na captura, envio, processamento, classificação e registro dos eventos RFID. A Tabela \ref{tab:testes-funcionais} apresenta a síntese da validação final.
