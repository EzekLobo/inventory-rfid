...
DEBUG = os.getenv("DJANGO_DEBUG", "1" if not IS_PRODUCTION else "0") == "1"
...
RFID_ONLINE_TIMEOUT_SECONDS = int(os.getenv("RFID_ONLINE_TIMEOUT_SECONDS", "15"))
RFID_COMMAND_TIMEOUT_SECONDS = int(os.getenv("RFID_COMMAND_TIMEOUT_SECONDS", "3"))
